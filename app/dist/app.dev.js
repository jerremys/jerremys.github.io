...
var _celebrations = require("./celebrations.js");
...
(function () {
  ...
  latin = {
    ...
    celebrate: function celebrate() {
      ...
      var celebrations = Object.keys(_celebrations.celebrations);
      latin.celebration = _celebrations.celebrations[celebrations[Math.floor(Math.random() * celebrations.length)]];
